    ...
    ! Algorithm 612: Integration over a Triangle
    ...
    !*************************************************************************
    subroutine quadrature_rules_tri( ng_tri,w,sx,sy )
    implicit none
    integer,intent(in) :: ng_tri
    real,intent(out) :: w(ng_tri),sx(ng_tri),sy(ng_tri)
